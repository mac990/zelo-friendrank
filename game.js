...
#zelo-liff-game {
  --zg-trail-gold: rgba(255, 212, 90, .72);
  --zg-trail-red: rgba(230, 0, 18, .66);
  --zg-trail-white: rgba(255, 255, 255, .72);
  --zg-trail-blue: rgba(63, 169, 255, .62);
  --zg-trail-green: rgba(6, 199, 85, .58);
}

/* ===================== 選陀螺畫面：卡片陀螺旋轉 ===================== */

.zg-top-card .zg-top-icon {
  animation:
    zgTopIconFloat 2.1s ease-in-out infinite,
    zgTopIconSpin 2.8s linear infinite;
  transform-origin: center;
  will-change: transform, filter;
}

.zg-top-card:nth-child(1) .zg-top-icon {
  animation-delay: 0s, 0s;
}

.zg-top-card:nth-child(2) .zg-top-icon {
  animation-delay: .12s, .18s;
}

.zg-top-card:nth-child(3) .zg-top-icon {
  animation-delay: .24s, .36s;
}

@keyframes zgTopIconSpin {
  from {
    rotate: 0deg;
  }
...
@keyframes zgTopIconFloat {
  0%,
  100% {
    translate: 0 0;
    filter:
      drop-shadow(0 0 8px rgba(255, 212, 90, .18))
      saturate(1.05);
  }
  ...
  50% {
    translate: 0 -3px;
    filter:
      drop-shadow(0 0 15px rgba(255, 212, 90, .32))
      saturate(1.2);
  }
}

/* 卡片陀螺外圈軌跡 */
.zg-top-card .zg-top-icon::before {
  content: "";
  position: absolute;
  inset: -12px;
  border-radius: 50%;
  ...
  background:
    conic-gradient(
      ...
      rgba(255, 255, 255, .8) 35deg 40deg,
      var(--zg-trail-gold) 41deg 58deg,
      transparent 59deg 130deg,
      var(--zg-trail-red) 131deg 145deg,
      transparent 146deg 360deg
    );
  opacity: .46;
  filter: blur(.2px);
  animation: zgOrbitTrail 1.15s linear infinite;
  z-index: -1;
}

.zg-top-card:nth-child(2) .zg-top-icon::before {
  background:
    conic-gradient(
      from 0deg,
      transparent 0deg 34deg,
      rgba(255, 255, 255, .78) 35deg 40deg,
      var(--zg-trail-blue) 41deg 62deg,
      transparent 63deg 130deg,
      rgba(255, 212, 90, .52) 131deg 145deg,
      transparent 146deg 360deg
    );
}

.zg-top-card:nth-child(3) .zg-top-icon::before {
  background:
    conic-gradient(
      from 0deg,
      transparent 0deg 34deg,
      rgba(255, 255, 255, .78) 35deg 40deg,
      var(--zg-trail-green) 41deg 62deg,
      transparent 63deg 130deg,
      rgba(255, 212, 90, .52) 131deg 145deg,
      transparent 146deg 360deg
    );
...
/* 選中狀態：更強金色能量環 */
.zg-top-card.selected .zg-top-icon {
  animation:
    zgSelectedTopPulse .72s ease-in-out infinite,
    zgTopIconSpin .68s linear infinite;
}

.zg-top-card.selected .zg-top-icon::before {
  inset: -16px;
  opacity: .86;
  filter:
    blur(.1px)
    drop-shadow(0 0 10px rgba(255, 212, 90, .72));
  background:
    conic-gradient(
      from 0deg,
      ...
      #ffffff 21deg 25deg,
      #ffd45a 26deg 56deg,
      transparent 57deg 112deg,
      #e60012 113deg 138deg,
      transparent 139deg 220deg,
      rgba(255, 255, 255, .85) 221deg 226deg,
      #ffd45a 227deg 255deg,
      transparent 256deg 360deg
    );
  animation: zgSelectedOrbitTrail .55s linear infinite;
}

.zg-top-card.selected .zg-top-icon::after {
  inset: -22px;
  border: 2px dashed rgba(255, 212, 90, .72);
  box-shadow:
    0 0 18px rgba(255, 212, 90, .36),
    inset 0 0 18px rgba(230, 0, 18, .22);
  animation: zgSelectedOuterRing 1.25s linear infinite;
}

@keyframes zgSelectedTopPulse {
  0%,
  100% {
    transform: scale(1);
    filter:
      drop-shadow(0 0 10px rgba(255, 212, 90, .45))
      drop-shadow(0 0 18px rgba(230, 0, 18, .25));
  }

  50% {
    transform: scale(1.07);
    filter:
      drop-shadow(0 0 18px rgba(255, 212, 90, .82))
      drop-shadow(0 0 28px rgba(230, 0, 18, .42));
  }
}

@keyframes zgSelectedOrbitTrail {
  from {
...
.zg-launch-top {
  overflow: visible;
  animation:
    zgLaunchSpin .55s linear infinite,
    zgLaunchGlowPulse .82s ease-in-out infinite !important;
}

.zg-launch-top::before {
  content: "";
  position: absolute;
  inset: -22px;
  border-radius: 50%;
  ...
  background:
    conic-gradient(
      ...
      rgba(255, 255, 255, .9) 27deg 32deg,
      rgba(255, 212, 90, .9) 33deg 78deg,
      transparent 79deg 140deg,
      rgba(230, 0, 18, .82) 141deg 178deg,
      transparent 179deg 255deg,
      rgba(255, 255, 255, .72) 256deg 262deg,
      rgba(255, 212, 90, .72) 263deg 292deg,
      transparent 293deg 360deg
    );
  filter:
    blur(.25px)
    drop-shadow(0 0 16px rgba(255, 212, 90, .62));
  opacity: .82;
  animation: zgLaunchEnergyRing .42s linear infinite;
}
...
.zg-launch-top::after {
  ...
  pointer-events: none;
  z-index: -2;
  border: 3px dashed rgba(255, 212, 90, .48);
  box-shadow:
    0 0 18px rgba(255, 212, 90, .32),
    inset 0 0 22px rgba(230, 0, 18, .22);
  opacity: .72;
  animation: zgLaunchOuterTrail 1.05s linear infinite;
}

@keyframes zgLaunchGlowPulse {
  0%,
  100% {
    filter:
      drop-shadow(0 0 12px rgba(255, 212, 90, .38))
      drop-shadow(0 0 22px rgba(230, 0, 18, .28));
  }

  50% {
    filter:
      drop-shadow(0 0 22px rgba(255, 212, 90, .78))
      drop-shadow(0 0 34px rgba(230, 0, 18, .48));
  }
}

@keyframes zgLaunchEnergyRing {
  from {
    transform: rotate(0deg) scale(1);
  }
...
.zg-arena .zg-launch-top {
  isolation: isolate;
}

.zg-arena::before {
  box-shadow:
    0 0 20px rgba(255, 212, 90, .22),
    inset 0 0 28px rgba(230, 0, 18, .18);
}
...
.zg-arena::after {
  ...
  background:
    conic-gradient(
      ...
      rgba(255, 255, 255, .16) 11deg 13deg,
      transparent 14deg 44deg,
      rgba(255, 212, 90, .22) 45deg 48deg,
      transparent 49deg 82deg,
      rgba(230, 0, 18, .24) 83deg 87deg,
      transparent 88deg 360deg
    );
  animation: zgLaunchArenaLines 2.1s linear infinite;
}

@keyframes zgLaunchArenaLines {
  from {
...
/* 因為 JS 直接寫 background，這裡用偽元素再疊一層光核 */
.zg-trail::after {
  content: "";
  position: absolute;
  inset: 18%;
...
.zg-player-top::before {
  ...
  background:
    conic-gradient(
      ...
      rgba(255, 255, 255, .78) 25deg 30deg,
      rgba(63, 169, 255, .72) 31deg 62deg,
      transparent 63deg 160deg,
      rgba(255, 212, 90, .58) 161deg 188deg,
      transparent 189deg 360deg
    );
  opacity: .68;
  filter:
    blur(.2px)
    drop-shadow(0 0 12px rgba(63, 169, 255, .52));
  animation: zgBattleTopTrail .36s linear infinite;
}
...
.zg-enemy-top::before {
  ...
  background:
    conic-gradient(
      ...
      transparent 0deg 24deg,
      rgba(255, 255, 255, .78) 25deg 30deg,
      rgba(230, 0, 18, .78) 31deg 66deg,
      transparent 67deg 160deg,
      rgba(255, 212, 90, .58) 161deg 188deg,
      transparent 189deg 360deg
    );
  opacity: .72;
  filter:
    blur(.2px)
    drop-shadow(0 0 12px rgba(230, 0, 18, .56));
  animation: zgBattleTopTrailReverse .34s linear infinite;
}

@keyframes zgBattleTopTrail {
  from {
    transform: rotate(0deg) scale(1);
  }
...
@keyframes zgBattleTopTrailReverse {
  from {
    transform: rotate(360deg) scale(1);
  }
...
.zg-battle-box::after {
  background:
    conic-gradient(
      ...
      rgba(255, 255, 255, .12) 13deg 15deg,
      transparent 16deg 38deg,
      rgba(255, 212, 90, .16) 39deg 42deg,
      transparent 43deg 78deg,
      rgba(230, 0, 18, .2) 79deg 83deg,
      transparent 84deg 140deg,
      rgba(255, 255, 255, .08) 141deg 143deg,
      transparent 144deg 360deg
    );
  animation: zgBattleArenaSpeedLines 3.2s linear infinite;
  opacity: .95;
}

@keyframes zgBattleArenaSpeedLines {
  from {
...
.zg-spark {
  ...
  height: 48px;
  background:
    radial-gradient(circle, #fff 0%, #fff4a8 16%, #ffd45a 30%, #ff7a1a 48%, rgba(230, 0, 18, .52) 62%, transparent 76%);
}
...
.zg-spark::after {
  ...
  border-radius: 999px;
  background:
    linear-gradient(90deg, transparent, rgba(255, 255, 255, .9), rgba(255, 212, 90, .8), transparent);
...
.zg-spark::after {
  ...
  background:
    linear-gradient(90deg, transparent, rgba(255, 255, 255, .82), rgba(230, 0, 18, .72), transparent);
}

.zg-spark.active::before,
.zg-spark.active::after {
  animation: zgSparkSlash .28s ease-out;
}

@keyframes zgSparkSlash {
  0% {
    opacity: 0;
    scale: .45;
  }
...
.zg-battle-top.win-pulse::before {
  opacity: .95;
  inset: -24px;
  background:
    conic-gradient(
      ...
      rgba(255, 255, 255, .95) 19deg 24deg,
      rgba(255, 212, 90, .92) 25deg 78deg,
      transparent 79deg 150deg,
      rgba(230, 0, 18, .78) 151deg 188deg,
      transparent 189deg 360deg
    );
  filter:
    blur(.2px)
    drop-shadow(0 0 18px rgba(255, 212, 90, .82));
  animation: zgWinnerTrail .28s linear infinite;
}

@keyframes zgWinnerTrail {
  from {
...
.zg-rank::after {
  ...
  background:
    conic-gradient(
      from 0deg,
      transparent 0deg 24deg,
      rgba(255, 255, 255, .7) 25deg 30deg,
      rgba(255, 212, 90, .78) 31deg 72deg,
      transparent 73deg 150deg,
      rgba(230, 0, 18, .58) 151deg 185deg,
      transparent 186deg 360deg
    );
  opacity: .7;
  filter: drop-shadow(0 0 16px rgba(255, 212, 90, .55));
  animation: zgRankTrail 1.8s linear infinite;
}

@keyframes zgRankTrail {
  from {
    transform: rotate(0deg) scale(1);
  }
